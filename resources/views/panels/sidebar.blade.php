...
<div class="main-menu menu-fixed {{($configData['theme'] === 'dark') ? 'menu-dark' : 'menu-light'}} menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto">
        <a class="navbar-brand" href="{{url('/')}}">
          ...
          <div class="brand-text brand-sidebar-text small pl-0 text-bold"><span class='text-dark'>NETZOPTIMIZE</span> <span class="text-primary"><i>SOCIETY</i></span></div>
        </a>
      </li>
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      @endphp
      <li class="nav-item {{ Route::currentRouteName() }} {{ Route::currentRouteName() === $menu->slug ? 'active' : '' }} {{ $custom_classes }}">
