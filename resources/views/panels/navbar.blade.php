        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="user-nav d-sm-flex d-none">
              ...
              <span class="user-status">Avaialble</span>
            </div>
            <span class="avatar">
              <img class="round" src="{{ auth()->user()->profileImage() }}" alt="avatar" height="40" width="40">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
            ...
            <a class="dropdown-item" href="{{ config('setting.wp_url') }}">
              <i class="mr-50" data-feather="home"></i> Visit Home
            </a>
            <a class="dropdown-item" href="{{ route('subscriber.events.index') }}">
              <i class="mr-50" data-feather="calendar"></i> Events
            </a>
            <a onclick="event.preventDefault();
            document.getElementById('logout-form').submit();" class="dropdown-item" href="{{url('auth/login-v2')}}">
