  ...
  <div class="auth-inner py-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <form data-btnload="true" class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
          @csrf
        ...
        <p class="text-center mt-2">
          @if (Route::has('login'))
          <a href="{{ route('login') }}" class="back-link custom-login-link">
